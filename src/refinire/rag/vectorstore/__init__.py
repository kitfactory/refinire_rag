...
Usage:
    from refinire.rag.vectorstore import VectorStore, OpenAIVectorStore, ChromaVectorStore
...
from refinire.rag.vectorstore.vector_store_base import VectorStore
