...
from ..loaders.loader import Loader, LoaderConfig
...
class CorpusManager:
    ...
    def _build_pipelines_from_stages(self, stages: List[str], 
        ...
        if knowledge_processors:
            loader_config = DocumentLoadConfig(load_strategy="FILTERED", filters={"processing_stage": "original"})
        ...
        loader_config = DocumentLoadConfig(load_strategy="FILTERED", filters={"processing_stage": source_stage})
    ...
    def get_documents_by_stage(self, processing_stage: str) -> List[Document]:
        ...
        loader = DocumentStoreLoader(self.document_store, 
                                   load_config=DocumentLoadConfig(load_strategy="FILTERED", 
